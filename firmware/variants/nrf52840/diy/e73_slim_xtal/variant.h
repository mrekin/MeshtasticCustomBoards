...
#define PIN_WIRE_SDA (0 + 29) // P0.29
#define PIN_WIRE_SCL (0 + 2) // P0.02

// LED
#define PIN_LED1 (32 +2) // P1.02
...
#define SX126X_DIO1 (0 + 17) // P0.17 IRQ
...
#define SX126X_BUSY (0 + 26) //P0.26
//#define SX126X_BUSY (32 + 13) //P1.13
