...
//KILL ANYWHERE #define LED_POWER 12           // add status LED (compatible with core-pcb and DIY targets)
...
#define LORA_SCK 	18	//5
#define LORA_MISO 	19
#define LORA_MOSI 	23	//27
#define LORA_CS 	 5	//18
...
#define SX126X_CS 	LORA_CS 	// 18 // NSS for SX126X
#define SX126X_DIO1 LORA_DIO1
#define SX126X_BUSY LORA_DIO2
#define SX126X_RESET LORA_RESET
#define SX126X_RXEN 33	// RADIOLIB_NC // Defining the RXEN ruins RFSwitching for the E22 900M30S in RadioLib
